...
MEAN_SHIFT_PROCESSING_OPTIONS = {
    ...
    "3": {
        "name": "PCA 95 Mean Shift",
        "description": "No resize and no sampling; apply PCA retaining 95% variance before Mean Shift.",
        "scale": 1.0,
        "use_sampling": False,
        "use_pca": True,
    },
...
def prepare_mean_shift_inputs(
    ...
    if scale != 1.0:
        ...
        resized_extractor = FeatureExtractor(processed_image)
